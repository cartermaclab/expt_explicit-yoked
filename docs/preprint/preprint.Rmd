...
table_1 <- data.frame(c(
  ...
  "", ""),
  c(
    "Before each trial, you will be asked whether you wish to watch a modeled demonstration of the task.",
    "If you choose YES, you will then be asked whether you want to watch the video in real-time or in",
    "slow-motion.",
    
    "Before each trial, you may or may not watch a modeled demonstration of the task based on a pre-",
    ...
    "Before each trial, you may or may not watch a modeled demonstration of the task based on the", 
...
apa_table(table_1, col.names = c(" ", "Acquisition instructions"), booktabs = TRUE, span_text_columns = TRUE, caption = "Group specific instructions detailing the observation schedule that would be experienced during Acquisition.")
...
```{r fig1, echo = FALSE, fig.cap = "(ref:fig1-caption)", out.width = "100%", out.height = "100%", fig.align = "center", fig.env = "figure*"}
...
table_2 <- data.frame(c(
  "Model viewing frequency",
  " ",
...
apa_table(table_2, col.names = c(" ", "Block 1", "Block 2", "Block 3", "Block 4", "Block 5"), booktabs = TRUE, span_text_columns = TRUE, caption = "The mean frequencies for each acquisition block of requesting to watch the video demonstration and choosing the regular viewing speed.", placement = "t")
...
All material, data, and scripts to reproduce our analyses and figures can be accessed here: https://github.com/cartermaclab/expt_explicit-yoked.
