...
apa_table(table_1, font_size = "scriptsize", col.names = c(" ", "Acquisition instructions"), booktabs = TRUE, span_text_columns = TRUE, caption = "Group specific instructions detailing the observation schedule that would be experienced during Acquisition.")
...
```{r fig1, echo = FALSE, fig.cap = "(ref:fig1-caption)", fig.align = "center", out.height = "55%"}
...
apa_table(table_2, font_size = "scriptsize", col.names = c(" ", "Block 1", "Block 2", "Block 3", "Block 4", "Block 5"), booktabs = TRUE, span_text_columns = TRUE, caption = "The mean frequencies for each acquisition block of requesting to watch the video demonstration and choosing the regular viewing speed.", placement = "t")
...
```{r fig2, echo = FALSE, fig.cap = "(ref:fig2-caption)", fig.align = "center", out.height = "75%"}
