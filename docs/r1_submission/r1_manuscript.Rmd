...
abstract: |
  ...
  ***Public Significance Statement***  
  The present study suggests that although university-aged students may experience a boost in feelings of autonomy when given choice over features of their learning environment, this boost does not enhance learning of a new motor skill. Additionally, it highlights that coaches and practictioners should be encouraged to incorporate other and more effective practice variables into their training regimes.
...
documentclass     : "apa7"
classoption       : "man" # man for manuscript & jou for journal
...
Over the years, this manipulation has been described using a variety of names (e.g., self- and/or learner-controlled; -regulated; -directed; -selected), but more recently it has been subsumed by autonomy-support. In fact, autonomy-support is considered such a robust learning variable that it is one of three key pillars in the recently proposed "OPTIMAL" theory of motor learning [@wulf2016]. @wulf2016 argued that providing learners with opportunities for choice---considered an autonomy-supportive practice manipulation---can facilitate motor performance and learning through enhanced expectancies for success and having the learner maintain their attentional focus on the task thereby reducing the need for self-regulatory activity [e.g., @abdollahipour2017; @chua2018; @wulf2018]. In other words, these psychological and attentional benefits, and concomitant increases in performance and learning are a by-product of exercising choice during practice. Overall, @wulf2016's "OPTIMAL" theory of motor learning provides a motivational account for the learning advantage of self-controlled practice conditions over yoked practice conditions. [ADD A FOOTNOTE ABOUT INFORMATION-PROCESSING BUT THAT IT IS THE MOTIVATIONAL VIEW THAT SEEMS TO HAVE GARNERED THE MOST ATTENTION]

Despite its prominent role within the "OPTIMAL" theory of motor learning, there are reasons to doubt the importance of autonomy-support through the provision of choice during practice. First, if the learning benefits arise out of the opportunity for choice itself then learning differences should not emerge between different self-controlled groups. However, in experiments where different groups of participants have choice over their feedback schedule, such learning differences have been found when this choice is made *after* rather than before a performance attempt [@chiviacowsky2005; @carter2014], when different criteria for success are provided to participants [@chiviacowsky2012], and when the absolute number of feedback choice opportunities are limited compared to unlimited at the outset of practice [@hansen2011; @patterson2011]. Second, the notion that practicing in a self-controlled group is in fact more autonomy-supportive than practicing in a yoked group has predominantly been assumed rather than supported empirically. 


there has been limited support for the notion that practicing in a self-controlled group is in fact perceived as more autonomy-supportive than being in a yoked group. 


@ste-marie2013, for example, had participants in the self-controlled and yoked groups complete the perceived choice subscale of the Intrinsic Motivation Inventory and failed to find the expected effect of higher self-reported scores during practice in the self-controlled group. Failures to detect increased perceptions of autonomy in self-controlled groups relative to yoked groups have also been reported by others [@barros2019; @carter2017a; @mckay2020b]. However, @mckay2020a recently found that practicing in a self-controlled group was perceived as more autonomy-supportive than practicing the same task in a yoked group. This increased perceived autonomy-support did not, however, translate into enhanced learning compared to the yoked group. Although the available literature does not provide substantial evidence that self-controlled practice is autonomy-supportive, this does not necessarily mean such a manipulation is not autonomy-supportive [@altman1995]. For instance, this effect may in fact be quite small and require much larger sample sizes to detect than those commonly used in motor learning experiments [@lohse2016].

There are at least two other methodological issues that warrant consideration. The first of these is that in self-controlled motor learning experiments participants in the self-controlled group are usually given choice over a single component (e.g., feedback or when to watch a modeled demonstration) of their practice and participants in the yoked group are not given choice over this component. However, within the context of practice itself there are many other opportunities for choice that participants may explore, independent of their assigned group. Target-based tasks such as basketball free throws [e.g., @aiken2012] or bean-bag tossing [@grand2015] are a popular choice in motor learning experiments and have been used in self-controlled learning experiments. While a participant in the yoked group may not be permitted choice over their feedback schedule (or some other practice variable) in these experiments, this does not preclude them from opportunities for choice---and thus autonomy-support---when deciding to try different throwing techniques, speeds, and/or release points. Thus, labeling yoked groups as being devoid of choice opportunities may be a misnomer. The other consideration relates to the instructions that are provided to participants in the yoked group. In the context of feedback[^1], these participants are typically informed that during practice they may or may not receive feedback after a given trial [e.g., @chiviacowsky2002; @patterson2010]. This means that participants in yoked groups are not even aware that they have been denied an opportunity for choice, nor that their feedback schedule was created by another participant who was given choice over when feedback was or was not provided. Either of these in isolation, or both simultaneously could contribute to the consistent finding that participants in self-controlled and yoked groups report similar perceived autonomy scores when asked about their opportunities for choices with respect to the motor task [@ste-marie2013] or about their practice environment in general [@barros2019; @carter2017a; @mckay2020b].
...
To test predictions based on the "OPTIMAL" theory regarding the role of motivation, enhanced expectancies, and autonomy-support, participants completed the interest/enjoyment and perceived competence subscales from the Intrinsic Motivation Inventory [@mcauley1989] and a custom scale regarding choice used in previous self-controlled motor learning experiments [@barros2019; @carter2017a]. The order of questions from each scale were randomized and each question was rated using a 7-point Likert scale. Participants answered these questions after the pre-test, after trials five and 25 of acquisition, and before the delayed retention test.
